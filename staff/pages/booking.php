                    ...
                    <div class="about span_1_of_2">
						...
						<div class="about-top">
							...
							<div class="desc span_3_of_2">
								<p class="p-link" style="font-size:15px">Artists/Casts: <?php echo $movie['cast']; ?></p>
								<p class="p-link" style="font-size:15px">Start Date: <?php echo date('d-M-Y', strtotime($movie['release_date'])); ?></p>
						...
						<table class="table table-hover table-bordered text-center">
                          ...
                          <td>
                          <select name="customerss">
                          <?php 

                            $uqry = mysqli_query($con, "select * from tbl_registration");
                            

                          while ($row = $uqry->fetch_assoc()){
                            $user_id = $row['id'];
                          ?>
                          <option value="x1">--Select Customer--</option>
                          <option value="<?php $user_id ?>"><?php echo $row['name']; ?></option>
                          ...
                          ?>
							...
							<tr>
								...
								<tr>
									...
									<td> 
									<span id="seat-details"></span>
									<br>
									<input type="hidden" name="selectedSeats" value="" id="seat-value">
								</td>
								</tr>
									<td>
										Amount
